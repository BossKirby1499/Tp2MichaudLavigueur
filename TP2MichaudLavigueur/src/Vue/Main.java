...
import Controleur.BtnModifier;
import Controleur.BtnNouveau;
import Controleur.ListListener;
...
public class Main extends JFrame {
	public Main() {
	  ...
	  btnNouveau = new JButton("Nouveau");
		...
		table.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				imageArtiste = new ImageIcon(Main.class.getResource(modele.getDonnees().get(numLigne).getPhoto())).getImage().getScaledInstance(190, 150, Image.SCALE_SMOOTH);
				 ...
				 lblAlbums.setIcon( new ImageIcon(Main.class.getResource("defaut.png")));
		...
		panel_image_album.setBounds(470, 400, 129,145);
		panel_image_album.add(lblAlbums);
	  ...
	  model = new DefaultListModel();
		...
		BtnNouveau nouveau = new BtnNouveau(btnAjouter, table, textField_Num, textField_Nom, checkBox_Membre,model,imageArtiste,lblArtiste,lblAlbums);
		BtnModifier modifier = new BtnModifier(btnModifier, table, textField_Num, textField_Nom, checkBox_Membre,model,imageArtiste,lblArtiste);
		btnNouveau.addActionListener(nouveau);
		btnAjouter.addActionListener(nouveau);		
		btnModifier.addActionListener(modifier);
		btnSupprimer.addActionListener(modifier);
		ListListener actionList = new ListListener(liste,lblAlbums);

...
public class BtnNouveau implements ActionListener{
	...
	Image img;
	JLabel lblArtiste;
	public BtnNouveau(JButton btn,JTable table,JTextField num,JTextField nom,JCheckBox checkBox, DefaultListModel<Albums> liste, Image imageArtiste,JLabel lblArtiste) {
		this.btn = btn;
		this.table = table;
		this.num = num;
		this.nom = nom;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btn) {
			...
			liste.clear();
			img = new ImageIcon(Main.class.getResource("defaut.png")).getImage().getScaledInstance(130, 150, Image.SCALE_SMOOTH);
